...
c     arquivo de saída para graficar
      ...
      open(unit=iout, FILE='saida-b2-15.dat')

c     cálculo da posição de cada andarilho e soma das médias
      M = 100000
      N = 1000 !número de passos
c     Neste próximo p mudei caso a caso na tarefa B2
      p = 1.e0/5.e0 !probabilidade direita (que vou mudando conforme o caso)
      soma1 = 0.e0
      soma2 = 0.e0
      do i = 1, M
          ipx = 0
